...
BEGIN TRAN
	...
	WHERE ID_TipoColectiva = (SELECT ID_TipoColectiva FROM TipoColectiva WHERE ClaveTipoColectiva = 'SWITCH')

	DECLARE @ID_Colectiva VARCHAR(50) = (SELECT ID_Colectiva FROM Colectivas WHERE ClaveColectiva = 'SWITCH') 
...
--	DECLARE @CuentaAuto VARCHAR(50) = 'CCLC'
	...
	--DECLARE @CuentaBAN VARCHAR(50) = 'HNL-BAN'
...
--	DECLARE @CuentaFEECOLL VARCHAR(50) = 'FEECOLL' 
	...
	--DECLARE @CuentaSTP VARCHAR(50) = 'HNL-STP'
